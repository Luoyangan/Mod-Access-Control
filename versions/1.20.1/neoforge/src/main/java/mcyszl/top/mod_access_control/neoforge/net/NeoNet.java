...
/**
 * NeoForge 网络适配层（MC 1.20.1 / NeoForge 47.x）。
 *
 ...
 *
 * <p>1.20.1 的 NeoForge 47.x 是 Forge 47.x 的 NeoForged 分支，公开 API 仍沿用
 * {@code net.minecraftforge.*} 命名空间（旧版 SimpleChannel 体系：
 * {@link NetworkRegistry#newSimpleChannel} + {@code SimpleChannel.messageBuilder} +
 * {@link NetworkEvent}），与 1.21.1 的 net.neoforged.* / ChannelBuilder 不同；
...
public final class NeoNet {
    ...
    private static void respondStage1(String json) {
        ...
        // 1.20.1 NeoForge 以 modId="forge" 注册自身，需按其实际 id 查询版本。
